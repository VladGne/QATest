...
public class DogsDemo {
    ...
    public static String[] getDogData(String dogsData[]){
        ...
        for (; dataIndex < dogsData.length; dataIndex++){
            ...
            else if(dogsData[dataIndex].equals(Dogs.Size.small.toString()) ||dogsData[dataIndex].equals(Dogs.Size.big.toString()) ||dogsData[dataIndex].equals(Dogs.Size.medium.toString())){
                dog[0] = dogsData[dataIndex];
            ...
            //If fist element - name
                ...
                else if(dogsData[dataIndex+1].equals(Dogs.Size.small.toString()) ||dogsData[dataIndex+1].equals(Dogs.Size.big.toString()) ||dogsData[dataIndex+1].equals(Dogs.Size.medium.toString())){
                    dog[1] = dogsData[dataIndex+1];
